...
class AnnotationClassProcess implements IProcess {

    private ProxyClassCreate create;

    AnnotationClassProcess(Elements elementUtils, Filer filer, Types typeUtils) {
        create = new ProxyClassCreate(false, ProxyClassCreate.CreateType.Class, elementUtils, filer, typeUtils);
    }
